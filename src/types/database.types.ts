  ...
  public: {
    Tables: {
      accepted_priority_notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "accepted_priority_notifications_accepted_by_fkey"
            columns: ["accepted_by"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "accepted_priority_notifications_priority_request_id_fkey"
            columns: ["priority_request_id"]
            isOneToOne: true
            referencedRelation: "priority_requests"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "accepted_priority_notifications_receiver_id_fkey"
            columns: ["receiver_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "accepted_priority_notifications_sender_id_fkey"
            columns: ["sender_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      delete_account: { Args: { p_user_id: string }; Returns: Json }
